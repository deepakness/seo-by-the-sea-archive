---
layout: default
title: SEO by the Sea Preservation Archive
...
<section class="home-hero">
  <div class="home-hero__content">
    <div class="home-hero__copy">
      ...
      <h1>SEO by the Sea</h1>
      <p class="hero-lede">
        Bill helped generations of SEOs, researchers, marketers, and search
        practitioners understand search patents, information retrieval,
        entities, PageRank, local search, and how search engines think.
      </p>
      <p class="hero-lede">
        This archive exists so that work remains discoverable even if the
...
<section class="section">
  <div class="section-inner">
    ...
    <h2>Readable, searchable, and attributed.</h2>
    <p class="section-lede">
      The archive keeps Bill's posts in Markdown with source URLs, dates,
      authorship, local media where available, and an audit trail for review.
    </p>
